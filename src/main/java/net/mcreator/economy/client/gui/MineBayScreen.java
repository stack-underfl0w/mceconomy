...
public class MineBayScreen extends AbstractContainerScreen<MineBayMenu> {
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 52, this.topPos + 34, 72, 20, Component.literal("List Items"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 43, this.topPos + 88, 93, 20, Component.literal("View Listings"), e -> {
			if (true) {
				EconomyMod.PACKET_HANDLER.sendToServer(new MineBayButtonMessage(1, x, y, z));
				MineBayButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}));
	}
}
