...
public class Modelcop<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("economy", "modelcop"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightArm_r1 = rightArm.addOrReplaceChild("rightArm_r1",
				CubeListBuilder.create().texOffs(40, 16).addBox(-8.0F, -2.0F, -19.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leftArm = body.addOrReplaceChild("leftArm", CubeListBuilder.create().texOffs(40, 16).mirror()
