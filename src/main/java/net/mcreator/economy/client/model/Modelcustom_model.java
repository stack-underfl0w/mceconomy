package net.mcreator.economy.client.model;
...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("economy", "modelcustom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(34, 65).addBox(-8.0F, -22.0F, -8.0F, 16.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 50)
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(48, 17).addBox(-8.5F, -5.0F, -3.0F, 18.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -32.0F, -3.0F, 0.2618F, 0.0F, 0.0F));
		PartDefinition bone2 = partdefinition.addOrReplaceChild(
				"bone2", CubeListBuilder.create().texOffs(72, 66).addBox(-6.0F, -15.0F, -5.0F, 12.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(72, 50).addBox(-6.0F, -12.0F, -5.0F, 12.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(45, 36).addBox(-8.0F, -1.0F, -5.0F, 16.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(0, 34)
