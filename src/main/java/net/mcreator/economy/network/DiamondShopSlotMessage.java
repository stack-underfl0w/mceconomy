...
public class DiamondShopSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public DiamondShopSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public DiamondShopSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(DiamondShopSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(DiamondShopSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = DiamondShopMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EconomyMod.addNetworkMessage(DiamondShopSlotMessage.class, DiamondShopSlotMessage::buffer, DiamondShopSlotMessage::new,
				DiamondShopSlotMessage::handler);
	}
}
