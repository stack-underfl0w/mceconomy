...
public class NewOreTraderGUIButtonMessage {
	private final int buttonID, x, y, z;

	public NewOreTraderGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public NewOreTraderGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(NewOreTraderGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(NewOreTraderGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = NewOreTraderGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EconomyMod.addNetworkMessage(NewOreTraderGUIButtonMessage.class, NewOreTraderGUIButtonMessage::buffer, NewOreTraderGUIButtonMessage::new,
				NewOreTraderGUIButtonMessage::handler);
	}
}
