...
import net.mcreator.economy.procedures.BruhProcedure;
...
public class TestGUIButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			BruhProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		EconomyMod.addNetworkMessage(TestGUIButtonMessage.class, TestGUIButtonMessage::buffer, TestGUIButtonMessage::new,
				TestGUIButtonMessage::handler);
	}
}
