...
public class BuyDiamondProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		}
		{
			...
			}.getScore("trade_balance", entity) - Math.round(new Object() {
				public int getAmount(int sltid) {
					if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current
							&& _current.get() instanceof Map _slots) {
						ItemStack stack = ((Slot) _slots.get(sltid)).getItem();
			...
			}.getAmount(0) / EconomyModVariables.MapVariables.get(world).DiamondCost) * EconomyModVariables.MapVariables.get(world).DiamondCost));
		}
		if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
