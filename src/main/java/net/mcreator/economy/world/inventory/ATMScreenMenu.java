...
public class ATMScreenMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ATMScreenMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
