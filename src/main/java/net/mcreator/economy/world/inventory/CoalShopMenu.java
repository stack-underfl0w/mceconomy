...
import net.mcreator.economy.network.CoalShopSlotMessage;
...
public class CoalShopMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CoalShopMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EconomyModMenus.COAL_SHOP.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			EconomyMod.PACKET_HANDLER.sendToServer(new CoalShopSlotMessage(slotid, x, y, z, ctype, meta));
			CoalShopSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
