...
public class DiamondCustomMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DiamondCustomMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EconomyModMenus.DIAMOND_CUSTOM.get(), id);
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 133, 47) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
