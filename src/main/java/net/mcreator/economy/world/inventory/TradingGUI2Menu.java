...
public class TradingGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TradingGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EconomyModMenus.TRADING_GUI_2.get(), id);
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 44, 52) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
